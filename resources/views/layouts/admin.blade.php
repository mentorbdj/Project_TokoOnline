...
<html dir="ltr" lang="en">
  <head>
    ...
    <title>{{$title ?? 'Page Belum Dikasih Title'}} | Toko Komputer</title>
    <!-- Favicon icon -->
    <link
      rel="icon"
      type="image/png"
  ...
  <body>
    ...
    >
      ...
      <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">{{$title ?? 'Page Belum Dikasih Title'}}</h4>
        ...
        <!-- ============================================================== -->
        <div class="container-fluid mb-0 pb-0" style="min-height: 0px !important;">
            @if ($errors->any())
